...
## **更新订阅**     
 ...
 - 进 **设置**页面, 更多设置；
  - **更新间隔**（小时单位）填写 24或12； **自动更新** 开启即可 ~
  - 当科学上网出现障碍或有非常多的超时线路时，请更新订阅获取最新的节点信息。


[![Stash-update sub.gif](https://image.dooo.ng/c/2024/09/17/66e947241e5fd.gif)](https://image.dooo.ng/c/2024/09/17/66e947241e5fd.gif)
