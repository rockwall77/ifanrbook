...
### 更新v2rayN订阅 与 在线更新v2rayN版本

  - 主界面再依次点击 **「订阅分组」**->「更新全部订阅(不通过代理/通过代理)」等待v2rayN出现节点线路服务器器列表。

  - 主界面再依次点击 **「检查更新」**，V2rayN,Xray-Core,sing-box Core,Geo files 会自动下载最新主程序与Core内核。

 <video width="840" height="460" controls>
  <source src="https://cdn.jsdelivr.net/gh/Dacui777/mypicgo@main/guide/v2-update.mp4">
